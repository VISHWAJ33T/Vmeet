...
const participantsRoom = document.querySelector(".participants-cont");
...
const configuration = { iceServers: [{ urls: "TURN:freeturn.net:3478" }] };
...
socket.on("joined", (msg, sendername, time) => {
  participantsRoom.scrollTop = participantsRoom.scrollHeight;
  participantsRoom.innerHTML += `<div class="joined">
    <div class="info">
        <div class="username">${sendername}</div>
        <div class="time">${time}</div>
    </div>
